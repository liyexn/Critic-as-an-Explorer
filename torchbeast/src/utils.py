...
def act(i: int,
    ...
    try:
        ...
        if flags.episodic_bonus_type in ['elliptical-icm', 'cae', 'caep', 'caep_wo_u']:

            if flags.episodic_bonus_type == 'caep':
        ...
        while True:
            ...
            if env_output['done'][0][0]:
                ...
                if flags.episodic_bonus_type in ['elliptical-icm', 'caep', 'caep_wo_u', 'cae']:
                    if flags.episodic_bonus_type == 'caep':
                        hidden_dim = flags.weighted_emb_size + gym_env.action_space.n
            ...
            for t in range(flags.unroll_length):
                ...
                elif flags.episodic_bonus_type in ['elliptical-icm', 'caep', 'caep_wo_u', 'cae']:
                    h = encoder_output.squeeze().detach()

                    if flags.episodic_bonus_type in ['caep', 'caep_wo_u', 'cae']:
